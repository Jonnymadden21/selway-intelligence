...
function getMockData(endpoint) {
  ...
  if (endpoint.startsWith('/api/leads')) {
    var leadData = [
      ...
      // === TRINITY AUTOMATION CANDIDATES (growing shops needing automation) ===
      { id: 3, company_name: 'Cascade Engineering Technologies', territory: 1, status: 'new', score: 80, heat: 'HOT', assigned_rep: '', sources: ['job'], created_at: '2026-03-24', recommendation: 'TRINITY CANDIDATE: Aerospace shop hiring multiple 5-axis operators across all shifts. Growing fast but can\'t find enough operators = perfect automation pitch. Trinity + Haas UMC-750 for unattended 5-axis.', notes: 'Canby, OR. Hiring all shifts. Source: ZipRecruiter' },
      { id: 4, company_name: 'RTC Aerospace', territory: 2, status: 'new', score: 85, heat: 'HOT', assigned_rep: '', sources: ['job'], created_at: '2026-03-24', recommendation: 'TRINITY CANDIDATE: Already running automated 5-axis cells with pallet systems and robotics. Hiring lead machinists for multi-shift. They understand automation value = easy Trinity conversation. Pitch Trinity + Haas VF-5 cells.', notes: 'Fife, WA. $35-$50/hr positions. Source: ZipRecruiter' },
      { id: 5, company_name: 'Hadrian Automation Inc.', territory: 4, status: 'new', score: 95, heat: 'HOT', assigned_rep: '', sources: ['defense'], created_at: '2026-03-24', recommendation: 'TRINITY CANDIDATE: AI-driven CNC factory. $39.2M defense contract (cumulative $80M). They ARE the automation story. Pitch Haas + Trinity as the production backbone. This could be a massive multi-machine deal.', notes: '$39.2M contract. Torrance, CA. Source: defense.gov 03/18' },

      // === HAAS VMC DISPLACEMENT OPPORTUNITIES ===
      { id: 6, company_name: 'Boeing Co.', territory: 2, status: 'new', score: 90, heat: 'HOT', assigned_rep: '', sources: ['defense', 'job'], created_at: '2026-03-24', recommendation: 'MULTI-SIGNAL: $2.4B+ E-7A Wedgetail + $38.6M P-8A contracts + hiring CNC machinists at Auburn. Pitch Haas VF-series for production overflow. Boeing supply chain shops are the real target here.', notes: 'Auburn/Tukwila, WA. Source: defense.gov, Boeing Careers' },
      { id: 7, company_name: 'L3Harris Interstate Electronics', territory: 4, status: 'new', score: 85, heat: 'HOT', assigned_rep: '', sources: ['defense', 'job'], created_at: '2026-03-24', recommendation: 'MULTI-SIGNAL: $77.8M tracking mount contract + hiring CNC machinists in LA. Pitch Haas VF-series for subassembly production. High-volume precision work = Haas sweet spot.', notes: 'Anaheim, CA. Source: defense.gov 03/18, Glassdoor' },
      { id: 8, company_name: 'Fluke Electronics Corp.', territory: 2, status: 'new', score: 80, heat: 'HOT', assigned_rep: '', sources: ['defense'], created_at: '2026-03-24', recommendation: 'NEW CAPACITY: $22.5M calibrator production contract. Needs manufacturing equipment for production ramp. Pitch Haas VF-2/VF-3 for precision component machining.', notes: 'Everett, WA. Source: defense.gov 03/19' },

      // === HAAS TURNING / ST-SERIES OPPORTUNITIES ===
      { id: 9, company_name: 'Vigor Marine LLC', territory: 1, status: 'new', score: 85, heat: 'HOT', assigned_rep: '', sources: ['defense'], created_at: '2026-03-24', recommendation: 'TURNING OPPORTUNITY: $17.9M shipyard maintenance contract. Ship repair = large diameter turning, boring, facing. Pitch Haas ST-40 or ST-35 for heavy-duty turning. SWAT accessories for the shop floor.', notes: 'Portland, OR. Source: defense.gov 03/20' },
      { id: 10, company_name: 'Machinio Okuma Seller — San Jose', territory: 3, status: 'new', score: 80, heat: 'HOT', assigned_rep: '', sources: ['marketplace'], created_at: '2026-03-24', recommendation: 'CONQUEST: Selling Okuma GENOS M560V with Renishaw probe. Shop is upgrading or downsizing. Pitch Haas VF-5 as replacement + SWAT accessories. ST-series for their turning needs.', notes: 'San Jose, CA. Source: CNCMachines.com listing #8517' },
      { id: 11, company_name: 'Machinio DMG Mori Seller — Santa Ana', territory: 4, status: 'new', score: 80, heat: 'HOT', assigned_rep: '', sources: ['marketplace'], created_at: '2026-03-24', recommendation: 'CONQUEST: Selling DMG Mori DMU 50 5-axis. Pitch Haas UMC-750 at half the cost of a new DMG. For 5-axis premium, pitch Matsuura MX-330.', notes: 'Santa Ana, CA. Source: Machinio' },

      // === FACILITY EXPANSION LEADS (new building = new machines) ===
      { id: 12, company_name: 'Anduril Industries', territory: 4, status: 'new', score: 90, heat: 'HOT', assigned_rep: '', sources: ['permit'], created_at: '2026-03-24', recommendation: 'GREENFIELD: $1B, 1.18M sq ft defense manufacturing campus in Long Beach/Lakewood. 5,500 jobs. Opening mid-2027. Get in NOW before they spec equipment. Pitch full Haas line + Trinity for their automated cells.', notes: 'Source: gov.ca.gov 01/26/2026' },
      { id: 13, company_name: 'Echodyne', territory: 2, status: 'new', score: 80, heat: 'HOT', assigned_rep: '', sources: ['permit'], created_at: '2026-03-24', recommendation: 'GREENFIELD: $40M radar manufacturing facility. 86,350 sq ft, 200+ employees. Production summer 2026. Pitch Haas Mini Mill / VF-2 for precision radar component machining.', notes: 'Kirkland, WA. Source: Robotics & Automation News 02/12' },
      { id: 14, company_name: 'Janicki Industries', territory: 2, status: 'new', score: 85, heat: 'HOT', assigned_rep: '', sources: ['permit', 'job'], created_at: '2026-03-24', recommendation: 'MULTI-SIGNAL: 162,000 sq ft aerospace composites facility with 5-axis CNC already specified. 350 new jobs. They are BUYING 5-axis machines right now. Pitch Matsuura MX-520 for 5-axis, Haas VF-series for support work.', notes: 'Hamilton, WA. Source: janicki.com, Cascadia Daily News' },
      { id: 15, company_name: 'LS Electric / MCM Engineering', territory: 5, status: 'new', score: 80, heat: 'HOT', assigned_rep: '', sources: ['permit'], created_at: '2026-03-24', recommendation: 'GREENFIELD: $168M, 294,000 sq ft across 3 new facilities. 250+ jobs over 5-7 years. Get on the vendor list early. Pitch Haas full line for their machine shop buildout.', notes: 'Iron County, UT. Source: Utah Business 03/19' },

      // === WARM LEADS ===
      { id: 16, company_name: 'American Precision Industries', territory: 1, status: 'new', score: 60, heat: 'WARM', assigned_rep: '', sources: ['job'], created_at: '2026-03-24', recommendation: 'WARM: Hiring 5-axis CNC programmer in Hillsboro, OR. Already running verticals, horizontals, and 5-axis. Pitch Matsuura for 5-axis upgrades, Haas for production VMCs.', notes: 'Source: americanprecisionindustries.com' },
      { id: 17, company_name: 'Spacecraft Components Corp.', territory: 6, status: 'new', score: 70, heat: 'HOT', assigned_rep: '', sources: ['job'], created_at: '2026-03-24', recommendation: 'HAAS SHOP: Already running HAAS mills and lathes. Hiring multiple CNC machinists with G-code. AS9100 aerospace. Pitch additional Haas machines + SWAT accessories + Trinity Automation for their existing Haas fleet.', notes: 'N. Las Vegas, NV. Source: buildsubmarines.com 03/14' },
